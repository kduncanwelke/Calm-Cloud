...
struct ActivityManager {
    static let activities = [
        ...
        Activity(title: "Practice breathing exercises", category: .mindfulness, id: 26),
        ...
        Activity(title: "Go outside and take photos", category: .nature, id: 35),
        ...
        Activity(title: "Open windows to feel the air", category: .nature, id: 33),
        ...
        Activity(title: "Play a videogame with friends", category: .interaction, id: 42),
        ...
        Activity(title: "Assemble a box of donations", category: .kindness, id: 20),
        ...
        Activity(title: "Swing on a set/porch swing", category: .physical, id: 31),
